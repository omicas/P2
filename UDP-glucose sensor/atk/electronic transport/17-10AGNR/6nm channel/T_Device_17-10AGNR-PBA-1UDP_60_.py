...
#VG=[-2.0,-1.5,-1.0,0.0,0.5,1.0,1.5]
T=numpy.linspace(0,2000,100)
G=numpy.zeros((len(VG),len(T)))
for index_vg, vg in enumerate(VG):
  transmission_spectrum=nlread('Device_17-10AGNR-PBA-1UDP_60_%s.nc'%vg, TransmissionSpectrum)[0]
...
numpy.savetxt('Device_17-10AGNR-PBA-1UDP_60_G_.txt',G)
