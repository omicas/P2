...
#VG=[-2.0,0.0,0.5,1.0,1.5,2.0]
VG=[0.0,0.5,1.0,1.5,2.0]
T=numpy.linspace(250,350,11)
G=numpy.zeros((len(VG),len(T)))
for index_vg, vg in enumerate(VG):
  transmission_spectrum=nlread('Device_17-10AGNR_60_PBE_%s.nc'%vg, TransmissionSpectrum)[0]
...
numpy.savetxt('Device_17-10AGNR_60_PBE_G.txt',G)
