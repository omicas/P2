...
for index_pref, pref in enumerate(prefix):
 for index_vg, vg in enumerate(VG):
  transmission_spectrum=nlread('Device_17-10AGNR%s_60_%s.nc'%(pref,vg), TransmissionSpectrum)[0]
...
numpy.savetxt('Device_17-10AGNR_60_G_%s.txt'%VG[0],G)
