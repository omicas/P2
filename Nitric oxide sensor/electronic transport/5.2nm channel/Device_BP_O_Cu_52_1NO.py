...
#        [left_electrode_calculator, right_electrode_calculator],
  ...
  nlsave('Device_BP_O_Cu_52_1NO_%s.nc'%vg, device_configuration)
...
# -------------------------------------------------------------
  ...
  nlsave('Device_BP_O_Cu_52_1NO_%s.nc'%vg, transmission_spectrum)
...
# -------------------------------------------------------------
  ...
  nlsave('Device_BP_O_Cu_52_1NO_%s.nc'%vg, iv_curve)
  nlprint(iv_curve)
