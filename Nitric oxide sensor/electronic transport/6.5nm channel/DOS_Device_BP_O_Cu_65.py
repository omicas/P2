...
VG=["1NO_-0.5","10NO_-0.5","15NO_-0.5"]
for vg in VG:
  path = u'Device_BP_O_Cu_65_%s.nc'%vg
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, electrostatic_difference_potential)
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, projected_local_density_of_states)
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, device_density_of_states)
