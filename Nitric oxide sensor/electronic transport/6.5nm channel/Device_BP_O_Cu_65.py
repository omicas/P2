...
#VG=[0.0,0.5,-0.5,1.0,-1.0,1.5,-1.5,2.0,-2.0]
for vg in VG:
  # Add metallic region
...
#        [left_electrode_calculator, right_electrode_calculator],
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, device_configuration)
...
# -------------------------------------------------------------
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, transmission_spectrum)
...
# -------------------------------------------------------------
  ...
  nlsave('Device_BP_O_Cu_65_%s.nc'%vg, iv_curve)
  nlprint(iv_curve)
